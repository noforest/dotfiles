...
détectée. Un groupe absent ici est ignoré silencieusement — c'est voulu pendant
le remplissage, mais ça veut dire qu'un oubli ne se signale pas tout seul.
...
le noyau et le bootloader sont déjà là et gérés par la distribution.
